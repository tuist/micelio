defmodule Micelio.HTTP.InferenceProfilesRouter do
  ...
  # Account configuration has no standalone account-owner registry yet. A
  # repository in that account is therefore the authorization anchor, and
  # only that repository's administrators can view or replace a profile.
